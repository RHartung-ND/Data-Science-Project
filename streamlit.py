...
if uploaded_file is not None:
    ...
    st.markdown("-----")
    st.header("Test your data against the machine learning model")
    # model_choice = st.selectbox("Models", [
    #         "None",
    #         "K-Nearest Neighbor",
    #         "Decision Tree",
    #         "Random Forest",
    ...
    model, accuracy, feature_columns = forest_model(df, n_estimators, max_depth, random_state)
    ...
    st.markdown(rf"The accuracy of the Decision Tree model with {n_estimators} estimators, a max depth of {max_depth}, and a random state of {random_state} is: :green[**$\LARGE {accuracy*100:.1f}\%$**]")
